# DisplayName: Jolla natrium/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: natrium
# DeviceVariant: natrium
# Brand: Jolla
...
repo --name=adaptation-common-natrium-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-natrium-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-natrium
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/natrium
